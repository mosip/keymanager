...
REVOKE ALL PRIVILEGES ON ALL TABLES IN SCHEMA keymgr FROM :mosipdbname;

REVOKE ALL PRIVILEGES ON ALL TABLES IN SCHEMA keymgr FROM sysadmin;

GRANT SELECT, INSERT, TRUNCATE, REFERENCES, UPDATE, DELETE ON ALL TABLES IN SCHEMA keymgr TO :mosipdbname;
